...
public class ReadExcel {
	...
	public ArrayList<String> getData(String sheetName, String testcaseName) throws IOException {
		...
		FileInputStream fis = new FileInputStream(projectPath+"\\src\\main\\java\\resources\\tempExcel.xlsx");
...
//.equalsIgnoreCase(testcaseName)
					...
					if (r.getCell(coloumn).getStringCellValue().contains(testcaseName)) {
